    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/products/**").hasAnyAuthority("ROLE_INVENTORY_MANAGER", "ROLE_ADMIN","ROLE_SUPPLY_CHAIN_COORDINATOR")
                        ...
                        .requestMatchers("/api/v1/warehouses/**").hasAnyAuthority("ROLE_INVENTORY_MANAGER", "ROLE_ADMIN","ROLE_SUPPLY_CHAIN_COORDINATOR")
